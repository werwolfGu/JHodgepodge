 ...
 */
@ChainService(value = "service4", order = 200, successSubResourceName = "subService1")
@Service
public class ChainService4 implements IChainService {

    private static Logger logger = LoggerFactory.getLogger(ChainService4.class);
