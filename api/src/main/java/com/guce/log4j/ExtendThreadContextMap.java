...
public class ExtendThreadContextMap implements ThreadContextMap, ReadOnlyStringMap {
    ...
    public ExtendThreadContextMap() {
        this(true);
    }

    public ExtendThreadContextMap(final boolean useMap) {
        this.useMap = useMap;
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof ExtendThreadContextMap) {
            final ExtendThreadContextMap other = (ExtendThreadContextMap) obj;
