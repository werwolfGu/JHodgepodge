...
-  **[mall-learning](https://github.com/macrozheng/mall-learning?utm_source=gold_browser_extension)**：包含了springboot Mybatis ES等；
...
6. **[gold-spring](https://github.com/eugenp/tutorials?utm_source=gold_browser_extension )**: Just Announced - "Learn Spring Security OAuth" tutorials
...
8. **[spark爬虫](https://github.com/LuckyZXL2016/Movie_Recommend?utm_source=gold_browser_extension)** ：基于Spark的电影推荐系统，包含爬虫项目、web网站、后台管理系统以及spark推荐系统
...
- **[seata](https://github.com/seata/seata?utm_source=gold_browser_extension)**：Seata is an easy-to-use, high-performance, open source distributed transaction solution
...
- **[kafkaDemo](https://github.com/confluentinc/kafka-streams-examples?utm_source=gold_browser_extension)**：Demo applications and code examples for Apache Kafka's Streams API
